...
export default function ChildDetailsModal() 
{
    ...
    return (
        ...
        <h1>{childDetails.firstName}  {childDetails.lastName}</h1>
        <div className="info-section">
            <div className="child-header">
                <img className="child-img" src={childDetails.imageUrl} alt={childDetails.title} />
                <h2>Oate Of Birth: {childDetails.DOB}</h2>
                
            </div>
            <p className="text">Group: {childDetails.currentGroup}</p>
            <p className="text">{childDetails.category}</p>
            <p className="text">{childDetails.summary}</p>
        </div>
        </section>
